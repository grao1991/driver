...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, CS490QueueInitialize)
#endif

NTSTATUS
CS490QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = CS490EvtIoDeviceControl;
    queueConfig.EvtIoStop = CS490EvtIoStop;
